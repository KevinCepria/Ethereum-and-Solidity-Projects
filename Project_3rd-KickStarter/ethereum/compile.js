...
const campainPath = path.resolve(__dirname, 'contracts', 'Campagin.sol'); // path of project and read contracts/Lottery.sol
...
console.log('Contracts successfully compiled in /build directory......');
